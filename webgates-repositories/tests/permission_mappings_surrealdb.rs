...
async fn surrealdb_permission_mapping_crud_and_queries() {
    ...
    let stored: Option<PermissionMapping> = repo
    ...
    // 2) Query by ID
    let fetched_by_id: Option<PermissionMapping> = repo
    ...
    let fetched_by_str: Option<PermissionMapping> = repo
    ...
    let all: Vec<PermissionMapping> = repo
        .list_all_mappings()
        .await
    ...
    let removed_by_str: Option<PermissionMapping> = repo
    ...
    let removed_again: Option<PermissionMapping> = repo
        .remove_mapping_by_string("read:api")
        .await
    ...
    let stored2: Option<PermissionMapping> = repo
    ...
    // remove by id
    let removed_by_id: Option<PermissionMapping> = repo
    ...
    let all_after: Vec<PermissionMapping> = repo
        .list_all_mappings()
        .await
...
async fn surrealdb_permission_mapping_uniqueness() {
    ...
    let stored1: Option<PermissionMapping> = repo
    ...
    let fetched_by_id = repo
        ...
        .await
        .expect("query after duplicate store failed");
    assert!(
